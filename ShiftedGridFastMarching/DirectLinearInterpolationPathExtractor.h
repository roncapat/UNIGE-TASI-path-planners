...
#ifndef RONCAPAT_GLOBAL_PLANNERS_DIRECTLINEARINTERPOLATIONPATHEXTRACTOR_H
#define RONCAPAT_GLOBAL_PLANNERS_DIRECTLINEARINTERPOLATIONPATHEXTRACTOR_H
...
template<typename T>
class DirectLinearInterpolationPathExtractor {
public:
    DirectLinearInterpolationPathExtractor(const ExpandedMap<Node, T> &map, const Graph &grid);
...
#include "DirectLinearInterpolationPathExtractor_impl.h"
