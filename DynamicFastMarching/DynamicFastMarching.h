...
using elem_type = Cell;
template<int OptimizationLevel>
using info_type = typename std::conditional<OptimizationLevel == 0, void, std::pair<Cell,Cell>>::type;

template<int OptimizationLevel>
class DFMPlanner : public ReplannerBase<DFMPlanner<OptimizationLevel>,
                                        elem_type,
                                        info_type<OptimizationLevel>,
                                        key_type> {
 public:
  typedef ReplannerBase<DFMPlanner<OptimizationLevel>,
                        elem_type,
                        info_type<OptimizationLevel>,
                        key_type> Base;
  friend Base;
